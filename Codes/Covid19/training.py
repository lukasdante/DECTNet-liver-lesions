...
from Covid19.Metrics import calculate_metric_other
from Covid19.Dataset import covid19_train_dataset, covid19_test_dataset
...
if __name__ == "__main__":
    ...
    root_dir = r"/home/lbl/Experiments/2022_9_15/"
    if not os.path.isdir(root_dir):
        os.mkdir(root_dir)

    save_path_covid19 = os.path.join(root_dir, r"covid19")
    if not os.path.isdir(save_path_covid19):
        os.mkdir(save_path_covid19)

    print("CaTNet-Covid19")
    model_Covid19_CaTNet = CaT_Net_with_Decoder_DeepSup(num_classes=2,
                                                        cnn_channels=32,
                                                        swin_trans_channels=24,
                                                        num_layers=[4, 4, 4, 4, 4])

    CaTNet_Covid19_logger_name = {}
    CaTNet_Covid19_logger_name["train_loss"] = "CaTNet_Covid19_train_loss"
    CaTNet_Covid19_logger_name["test_loss"] = "CaTNet_Covid19_test_loss"
    CaTNet_Covid19_logger_name["train_metrics"] = "CaTNet_Covid19_train_metrics"
    CaTNet_Covid19_logger_name["test_metrics"] = "CaTNet_Covid19_test_metrics"
    two_classify_decoder_deep_supervision_trainer(save_path=save_path_covid19,
                                                  model=model_Covid19_CaTNet,
                                                  hyperparameter=two_classify_hyperparameters,
                                                  train_dataset=covid19_train_dataset,
                                                  test_dataset=covid19_test_dataset,
                                                  logger_name=CaTNet_Covid19_logger_name)
