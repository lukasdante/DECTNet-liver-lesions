...
def multi_classify_decoder_deep_supervision_trainer(save_path, model, hyperparameter, train_dataset, test_dataset, logger_name):
    ...
    # save_logging
    logging.getLogger(name=logger_name["train_Cyst_metrics"])
    logging.getLogger(name=logger_name["train_Cyst_metrics"]).setLevel(logging.DEBUG)
    train_Cyst_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "train_Cyst_metric.txt"), "a"))
    train_Cyst_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["train_Cyst_metrics"]).addHandler(train_Cyst_metrics_handle)

    logging.getLogger(name=logger_name["train_Abscess_metrics"])
    logging.getLogger(name=logger_name["train_Abscess_metrics"]).setLevel(logging.DEBUG)
    train_Abscess_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "train_Abscess_metric.txt"), "a"))
    train_Abscess_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["train_Abscess_metrics"]).addHandler(train_Abscess_metrics_handle)

    logging.getLogger(name=logger_name["train_Tumor_metrics"])
    logging.getLogger(name=logger_name["train_Tumor_metrics"]).setLevel(logging.DEBUG)
    train_Tumor_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "train_Tumor_metric.txt"), "a"))
    train_Tumor_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["train_Tumor_metrics"]).addHandler(train_Tumor_metrics_handle)

    # save_logging
    logging.getLogger(name=logger_name["test_Cyst_metrics"])
    logging.getLogger(name=logger_name["test_Cyst_metrics"]).setLevel(logging.DEBUG)
    test_Cyst_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "test_Cyst_metric.txt"), "a"))
    test_Cyst_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["test_Cyst_metrics"]).addHandler(test_Cyst_metrics_handle)

    logging.getLogger(name=logger_name["test_Abscess_metrics"])
    logging.getLogger(name=logger_name["test_Abscess_metrics"]).setLevel(logging.DEBUG)
    test_Abscess_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "test_Abscess_metric.txt"), "a"))
    test_Abscess_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["test_Abscess_metrics"]).addHandler(test_Abscess_metrics_handle)

    logging.getLogger(name=logger_name["test_Tumor_metrics"])
    logging.getLogger(name=logger_name["test_Tumor_metrics"]).setLevel(logging.DEBUG)
    test_Tumor_metrics_handle = logging.StreamHandler(open(os.path.join(save_path, "test_Tumor_metric.txt"), "a"))
    test_Tumor_metrics_handle.setLevel(logging.DEBUG)
    logging.getLogger(name=logger_name["test_Tumor_metrics"]).addHandler(test_Tumor_metrics_handle)
    ...
    for epoch in range(epochs):
        ...
        logging.getLogger(name=logger_name["train_Abscess_metrics"]).info(
            "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
                format(train_metric[0][0],
                       ...
                       train_metric[0][3],
                       train_metric[0][4]))
        logging.getLogger(name=logger_name["train_Cyst_metrics"]).info(
            "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
                format(train_metric[1][0],
                       ...
                       train_metric[1][3],
                       train_metric[1][4]))
        logging.getLogger(name=logger_name["train_Tumor_metrics"]).info(
            "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
        ...
        print("The average loss for epoch", epoch + 1, "is:", sum(losses) / len(losses))
        print("Abscess Dice cofficient:", str(train_metric[0][0]))
        print("Cyst Dice cofficient:", str(train_metric[1][0]))
        print("Tumor Dice cofficient:", str(train_metric[2][0]))
        ...
        with torch.no_grad():
            ...
            logging.getLogger(name=logger_name["test_Abscess_metrics"]).info(
                "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
                    format(metric[0][0],
                           metric[0][1],
                           metric[0][2],
                           metric[0][3],
                           metric[0][4]))
            logging.getLogger(name=logger_name["test_Cyst_metrics"]).info(
                "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
                    format(metric[1][0],
                           metric[1][1],
                           metric[1][2],
                           metric[1][3],
                           metric[1][4]))
            logging.getLogger(name=logger_name["test_Tumor_metrics"]).info(
                "dice:{}, jaccard:{}, accuracy:{}, hd95:{}, asd:{}".
                    format(metric[2][0],
                           metric[2][1],
                           metric[2][2],
            ...
            print("Abscess Dice cofficient:", str(metric[0][0]))
            print("Cyst Dice cofficient:", str(metric[1][0]))
            print("Tumor Dice cofficient:", str(metric[2][0]))
...
if __name__ == "__main__":
    ...
    CaTNet_mms_logger_name["train_Abscess_metrics"] = "CaTNet_mms_train_Abscess_metrics"
    CaTNet_mms_logger_name["train_Tumor_metrics"] = "CaTNet_mms_train_Tumor_metrics"
    CaTNet_mms_logger_name["train_Cyst_metrics"] = "CaTNet_mms_train_Cyst_metrics"
    CaTNet_mms_logger_name["test_Abscess_metrics"] = "CaTNet_mms_test_Abscess_metrics"
    CaTNet_mms_logger_name["test_Tumor_metrics"] = "CaTNet_mms_test_Tumor_metrics"
    CaTNet_mms_logger_name["test_Cyst_metrics"] = "CaTNetmms_test_Cyst_metrics"
